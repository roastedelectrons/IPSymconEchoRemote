...
class EchoConfigurator extends IPSModule
{
    ...
    private const DEVICETYPES = [
        ...
        'A1WZKXFLI43K86'   => ['name' => 'Fire TV Stick 4K Max (2.Gen)'],
        ...
        'A1VGB7MHSIEYFK'   => ['name' => 'Fire TV Cube (3.Gen)'],
        ...
        'A13W6HQIHKEN3Z'   => ['name' => 'Echo Auto (Gen.2)'],
